...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <h2>Status of MRF Number <?php echo e($mrfNumber); ?></h2>
            <p>The Manpower Requisition Form (MRF Number) <strong><?php echo e($mrfNumber); ?></strong> has been <strong><?php echo e($status); ?></strong>.</p>
            ...
            <?php else: ?>
                <p>Unfortunately, the MRF Number <?php echo e($mrfNumber); ?> has not been approved. Please review the feedback provided and consider resubmitting.</p>
            <?php endif; ?>
...
<?php /**PATH D:\RMS_V2\RMSAPI_V2\resources\views/emails/mrfMail.blade.php ENDPATH**/ ?>